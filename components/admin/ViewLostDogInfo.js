...
const ViewLostDogInfoScreen = ({ onNavigateBack, dog }) => {
    const defaultDogImage = require('../../assets/images/dog-icon.png');
    const dogImage = dog?.image || defaultDogImage;
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                ...
                <Text style={styles.title}>View Lost Pet Info</Text>
                <ScrollView
                    ...
                    <View style={styles.dogCard}>
                        ...
                        <View style={styles.infoCard}>
                            ...
                            <View style={styles.infoContainer}>
                                ...
                                <Text style={styles.value}>{dog?.name || 'N/A'}</Text>
                            ...
                            <View style={styles.infoContainer}>
                                ...
                                <Text style={styles.value}>{dog?.userId?.fullName || 'N/A'}</Text>
                            </View>
                            <View style={styles.infoContainer}>
                                <Text style={styles.label}>Contact number:</Text>
                                <Text style={styles.value}>{dog?.userId?.contact || 'N/A'}</Text>
                            </View>
                        </View>
                    </View>
                </ScrollView>
...
export default ViewLostDogInfoScreen;